...
class BDoubleTests : XCTestCase {
    ...
    var test_Big_Number: String!

	override func setUp() {
		super.setUp()
        self.test_Big_Number = BInt(200).factorial().description
	}
	
	override func tearDown() {
        self.test_Big_Number = nil
		super.tearDown()
	}
...
//		// Use XCTAssert and related functions to verify your tests produce the correct results.
	...
	func testPow() {
		...
		XCTAssertEqual(pow(BDouble("27")!,BigInt("3")), BDouble("19683")!)
        XCTAssertEqual((BDouble("27")!**BigInt("3")), BDouble("19683")!)
		XCTAssertEqual(pow(BDouble("27")!,BigInt("3")), BDouble("19683")!)
	...
	func testRounding() {
		XCTAssertEqual(BDouble("-1.0")?.rounded(), BigInt("-1"))
		XCTAssertEqual(BDouble("-1.1")?.rounded(), BigInt("-1"))
		XCTAssertEqual(BDouble("-1.5")?.rounded(), BigInt("-1"))
		XCTAssertEqual(BDouble("-1.6")?.rounded(), BigInt("-2"))
		XCTAssertEqual(BDouble("0")?.rounded(), BigInt("0"))
		XCTAssertEqual(BDouble("1.0")?.rounded(), BigInt("1"))
		XCTAssertEqual(BDouble("1.1")?.rounded(), BigInt("1"))
		XCTAssertEqual(BDouble("1.5")?.rounded(), BigInt("1"))
		XCTAssertEqual(BDouble("1.6")?.rounded(), BigInt("2"))

		XCTAssertEqual(floor(BDouble(-1.0)), BigInt("-1"))
		XCTAssertEqual(floor(BDouble(-1.1)), BigInt("-2"))
		XCTAssertEqual(floor(BDouble(-1.5)), BigInt("-2"))
		XCTAssertEqual(floor(BDouble(-1.6)), BigInt("-2"))
		XCTAssertEqual(floor(BDouble(0)), BigInt("0"))
		XCTAssertEqual(floor(BDouble(1.0)), BigInt("1"))
		XCTAssertEqual(floor(BDouble(1.1)), BigInt("1"))
		XCTAssertEqual(floor(BDouble(1.5)), BigInt("1"))
		XCTAssertEqual(floor(BDouble(1.6)), BigInt("1"))

		XCTAssertEqual(ceil(BDouble(-1.0)), BigInt("-1"))
		XCTAssertEqual(ceil(BDouble(-1.1)), BigInt("-1"))
		XCTAssertEqual(ceil(BDouble(-1.5)), BigInt("-1"))
		XCTAssertEqual(ceil(BDouble(-1.6)), BigInt("-1"))
		XCTAssertEqual(ceil(BDouble(0)), BigInt("0"))
		XCTAssertEqual(ceil(BDouble(1.0)), BigInt("1"))
		XCTAssertEqual(ceil(BDouble(1.1)), BigInt("2"))
		XCTAssertEqual(ceil(BDouble(1.5)), BigInt("2"))
		XCTAssertEqual(ceil(BDouble(1.6)), BigInt("2"))
	}
...
//    func testPerformanceBigIntInit() {
//        self.measure {
//            for _ in (0...100) {
//                let _ = BDouble(BigInt(test_Big_Number)!)
//            }
//        }
//    }

//    func testPerformanceBIntInit() {
//        self.measure {
//            for _ in (0...100) {
//                let _ = BDouble(BInt(test_Big_Number)!)
//            }
//        }
//    }
